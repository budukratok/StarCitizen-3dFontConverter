...
// modified by BK https://github.com/budukratok
public class ColladaExporter : IDisposable
{
                ...
                .AppendChild(
                    ...
                    .AppendChild(
                        ...
                        .AppendChild(
                            ...
                            .AppendChild(this.xml.CreateTextNode(Environment.MachineName.ToString()))
                            .ParentNode
                        )
                        .ParentNode
                        .AppendChild(
    ...
    public XmlNode AddGeometry(string id, Mesh sourceMesh)
    {
        ...
        if (sourceMesh.vertexCount > 0 )
        {
            ...
            {
                str.Append((-sourceMesh.vertices[i].x).ToString("0.######"));
                str.Append(" ");
                str.Append(sourceMesh.vertices[i].y.ToString("0.######"));
                str.Append(" ");
                str.Append(sourceMesh.vertices[i].z.ToString("0.######"));
                if (i + 1 != n)
                    str.Append(" ");
            }
        ...
        if (sourceMesh.colors.Length > 0)
        {
            ...
            for (int i = 0, n = sourceMesh.colors.Length; i < n; ++i)
            {
                ...
                //str.Append(" ");
                str.Append(sourceMesh.colors[i].r.ToString("0.######"));
                str.Append(" ");
                str.Append(sourceMesh.colors[i].g.ToString("0.######"));
                str.Append(" ");
                str.Append(sourceMesh.colors[i].b.ToString("0.######"));
                if (i + 1 != n)
                    str.Append(" ");
            }
            nodeB.AppendChild(this.xml.CreateTextNode(str.ToString()));
        ...
        if (sourceMesh.uv.Length > 0)
        {
            nodeA = mesh.AppendChild(this.xml.CreateElement("source", COLLADA));
            attr = this.xml.CreateAttribute("id");
            attr.Value = id + "-mesh-UV";
            nodeA.Attributes.Append(attr);

            nodeB = nodeA.AppendChild(this.xml.CreateElement("float_array", COLLADA));
            attr = this.xml.CreateAttribute("id");
            attr.Value = id + "-mesh-UV-array";
            nodeB.Attributes.Append(attr);
            attr = this.xml.CreateAttribute("count");
            attr.Value = (sourceMesh.uv.Length * 3).ToString();
            nodeB.Attributes.Append(attr);
            ...
            for (int i = 0, n = sourceMesh.uv.Length; i < n; ++i)
            {
                //str.Append(mesh.colors[i].a.ToString());
                //str.Append(" ");
                str.Append(sourceMesh.uv[i].x.ToString("0.######"));
                str.Append(" ");
                str.Append(sourceMesh.uv[i].y.ToString("0.######"));
                if (i + 1 != n)
                    str.Append(" ");
            }
            nodeB.AppendChild(this.xml.CreateTextNode(str.ToString()));
        ...
        if (sourceMesh.normals.Length > 0)
        {
            ...
            {
                str.Append((-sourceMesh.normals[i].x).ToString("0.######"));
                str.Append(" ");
                str.Append(sourceMesh.normals[i].y.ToString("0.######"));
                str.Append(" ");
                str.Append(sourceMesh.normals[i].z.ToString("0.######"));
                if (i + 1 != n)
                    str.Append(" ");
            }
            nodeB.AppendChild(this.xml.CreateTextNode(str.ToString()));
        ...
        // Tangents
        if (sourceMesh.tangents.Length > 0)
        {
            nodeA = mesh.AppendChild(this.xml.CreateElement("source", COLLADA));
            attr = this.xml.CreateAttribute("id");
            attr.Value = id + "-mesh-tang";
            nodeA.Attributes.Append(attr);
            attr = this.xml.CreateAttribute("name");
            attr.Value = id + "-tang";
            nodeA.Attributes.Append(attr);
            ...
            nodeB = nodeA.AppendChild(this.xml.CreateElement("float_array", COLLADA));
            attr = this.xml.CreateAttribute("id");
            attr.Value = id + "-mesh-tang-array";
            nodeB.Attributes.Append(attr);
            attr = this.xml.CreateAttribute("count");
            attr.Value = (sourceMesh.tangents.Length * 3).ToString();
            nodeB.Attributes.Append(attr);

            str = new StringBuilder();
            for (int i = 0, n = sourceMesh.tangents.Length; i < n; ++i)
            {
                str.Append((-sourceMesh.tangents[i].x).ToString("0.######"));
                str.Append(" ");
                str.Append(sourceMesh.tangents[i].y.ToString("0.######"));
                str.Append(" ");
                str.Append(sourceMesh.tangents[i].z.ToString("0.######"));
                if (i + 1 != n)
                    str.Append(" ");
            }
            nodeB.AppendChild(this.xml.CreateTextNode(str.ToString()));
            ...
            nodeC.Attributes.Append(attr);
            attr = this.xml.CreateAttribute("count");
            attr.Value = sourceMesh.tangents.Length.ToString();
            nodeC.Attributes.Append(attr);
            attr = this.xml.CreateAttribute("stride");
            attr.Value = "3";
            nodeC.Attributes.Append(attr);
        ...
        // Vertices
        {
            ...
            if (sourceMesh.tangents.Length > 0)
            {
                ...
                nodeB.Attributes.Append(attr);
                attr = this.xml.CreateAttribute("offset");
                //attr.Value = (normalsExists ? offset-1 : offset).ToString();
                attr.Value = offset.ToString();
                nodeB.Attributes.Append(attr);
